 ...
 * @author My PC
 */
public class PlayerProfileSettingsUI extends javax.swing.JFrame {

    /**
     * Creates new form GameMasterUI
     */
    public PlayerProfileSettingsUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlayerProfileSettingsUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlayerProfileSettingsUI().setVisible(true);
            }
        });
    }
